...
$sql1= "INSERT INTO orders (item_name,item_price,item_qty,order_by,date ) VALUES ('$itemName','$itemPrice','$itemQty','$orderBy', NOW())";
...
<br>
	...
	<br>
            ...
            <form method="POST" action="typesD1.php" class="row">
			<br>
